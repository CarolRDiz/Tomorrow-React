/**
 * Crea una URL entera desde la URL base y parámetros de la consulta.
 * @param url
 * @param consulta
 * @returns {string}
 */
const crearURL = ({ url, consulta = {} }) => {
...
export { crearURL, addHours, formatTime, prettyPrintWeatherCode };
